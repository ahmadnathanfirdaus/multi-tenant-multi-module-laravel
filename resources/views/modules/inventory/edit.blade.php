<x-layouts.app>
    <div class="p-6">
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('modules.inventory.update', $product) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="cost" id="cost" value="{{ old('cost', $product->cost) }}" step="0.01" min="0"
                    ...
                    <div>
                        ...
                        <input type="number" name="min_stock_level" id="min_stock_level" value="{{ old('min_stock_level', $product->min_stock_level) }}" min="0" required
                    ...
                    <div class="flex items-center">
                        <label class="flex items-center">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $product->is_active) ? 'checked' : '' }} class="form-checkbox h-5 w-5 text-orange-600">
                ...
                <div class="flex items-center justify-between">
                    <a href="{{ route('modules.inventory.show', $product) }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                        <i class="fas fa-arrow-left mr-2"></i>Back to Product
                    </a>
                    <div class="flex space-x-2">
                        <a href="{{ route('modules.inventory.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-700 font-bold py-2 px-4 rounded">
                            Cancel
                        </a>
