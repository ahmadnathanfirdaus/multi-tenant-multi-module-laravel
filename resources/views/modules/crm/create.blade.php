<x-layouts.app>
    <div class="p-6">
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-2">Create a new contact in your CRM system</p>
        </div>

        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('modules.crm.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="deal_value" id="deal_value" value="{{ old('deal_value') }}" step="0.01" min="0"
