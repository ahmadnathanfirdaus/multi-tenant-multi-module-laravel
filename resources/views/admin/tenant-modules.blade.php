...
<head>
    ...
    <title>Tenant Module Management - Multitenant App</title>
...
<body class="bg-gray-100">
    <div class="min-h-screen">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/admin/modules" class="text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                                    <i class="fas fa-puzzle-piece mr-2"></i>Modules
                                </a>
                                <a href="/admin/tenant-modules" class="bg-blue-500 text-white px-3 py-2 rounded-md text-sm font-medium">
        ...
        <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            @livewire('tenant-module-manager')
        </main>
    </div>
